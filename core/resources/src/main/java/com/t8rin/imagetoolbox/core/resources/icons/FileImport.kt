...
val Icons.Outlined.FileImport: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(11.562f, 15.969f)
            lineToRelative(-2.25f, -2.25f)
            curveToRelative(-0.2f, -0.2f, -0.296f, -0.433f, -0.287f, -0.7f)
            reflectiveCurveToRelative(0.113f, -0.5f, 0.313f, -0.7f)
            curveToRelative(0.2f, -0.183f, 0.433f, -0.279f, 0.7f, -0.287f)
            curveToRelative(0.267f, -0.008f, 0.5f, 0.088f, 0.7f, 0.288f)
            lineToRelative(2.25f, 2.25f)
